...
const viewConfig = {
  uiViewClassName: 'AIR<provider>GroundOverlay',
  validAttributes: {
    coordinate: true,
  },
};
...
class GroundOverlay extends React.Component {
  ...
  render() {
    ...
    //   />
      ...
      const GroundOverlay = this.getAirComponent();
...
GroundOverlay.viewConfig = viewConfig;
...
GroundOverlay.Animated = Animated.createAnimatedComponent(GroundOverlay);

module.exports = decorateMapComponent(GroundOverlay, {
